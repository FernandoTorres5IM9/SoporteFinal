    ...
    <body>
        <%
            ...
            while (Arr.next()) {
                ...
                out.println("<tr>");
                out.println("<th width='8%'></th><th width='16%'>Fecha de Registro</th><th width='15%'>Nombre</th><th width='10%'>Area</th><th width='13%'>Material</th><th>Especificaciones</th><form method='post' action='eliminarMatSob.jsp'><button class='btn waves-effect waves-light black' type='submit'  name='action'onclick='hi()'><i class='small material-icons'>send</i></button></form>");
                out.println("<script>function hi(){alert('Reportes enviados a mandenimiento0')};</script>");
                out.println("</tr>");
                out.println("<tr>");
